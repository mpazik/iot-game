package dzida.server.app.instance.position.model;
...
public class MoveTest {
    ...
    public class PositionAtTime {
        ...
        public class ForMoveFromSinglePoint {
            ...
            public void returnsSamePositionForMoveTime() {
                Assertions.assertThat(move).hasPositionAtTime(startTime, position);
            }

            @Test
            public void returnsSamePositionForTimeBeforeMoveStarted() {
                Assertions.assertThat(move).hasPositionAtTime(startTime - 1000, position);
            }
        ...
        public class ForMoveFromManyPoints {
            ...
            public void returnsStartPositionForStartTime() {
                Assertions.assertThat(move).hasPositionAtTime(startTime, startPosition);
            }

            @Test
            public void returnsEndPositionForEndTime() {
                Assertions.assertThat(move).hasPositionAtTime(endTime, endPosition);
            }

            @Test
            public void returnsMiddlePositionForMiddleTime() {
                Assertions.assertThat(move).hasPositionAtTime(middleTime, middlePosition);
            }
            ...
            public void returnsHalfWayBetweenFirstAndSecondPositionForQuarterTime() {
                ...
                Assertions.assertThat(move).hasPositionAtTime(quarterTime, quarterPosition);
            }
        }
    }
    ...
    public class angleAtTime {
        ...
        public void returns0_WhenTimeIsBeforeMoveStart() {
            Assertions.assertThat(move).hasAngleAtTime(startTime - 1000, zeroAngle);
        }

        @Test
        public void returnsLastAngle_WhenTimeIsAfterMoveStart() {
            Assertions.assertThat(move).hasAngleAtTime(endTime + 1000, endAngle);
        }
